    ...
    $("button.proceed").click(function(event) {
        ...
        $("button#final-order").click(function(event) {
            ...
            if ($("input#name").val() && $("input#phone").val() && $("input#location").val() != "") {
                ...
                $("#finallmessage").append(person + ", We have recieved your order and we will delivere to you at " + location + ". Prepare sh. " + deliceryamount);
                $("#totalbill").hide();
                $("#finallmessage").slideDown(1500);
            } else {
                alert("Fill details for delivery!");
                $(".delivery").show();
